"""Utility script to evaluate CDVIB beta settings on MNIST."""
...
DEFAULT_CONFIG = "mnist_gauss_1.yaml"
DEFAULT_OUTPUT = BASE_DIR / "experiments" / "mnist_cdvib_beta_results.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run MNIST SQVAE experiments across multiple seeds and CDVIB betas"
        )
    )
    parser.add_argument(
        "--config",
