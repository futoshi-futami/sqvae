"""Utility script to evaluate CDVIB beta settings on CelebA."""
...
DEFAULT_CONFIG = "celeba_gauss_1.yaml"
DEFAULT_OUTPUT = BASE_DIR / "experiments" / "celeba_cdvib_beta_results.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run CelebA SQVAE experiments across multiple seeds and CDVIB betas"
        )
    )
    parser.add_argument(
        "--config",
